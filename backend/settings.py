...
# ZENKOO DATABASE WITH POSTGRESQL + .ENV
...
# Comprime los archivos y mejora el rendimiento
...
# CHANNEL LAYERS Layers (por defecto en memoria)
CHANNEL_LAYERS = {
    "default": {
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=12), # Token válido por 12 horas
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7), # Se puede refrescar el token durante 7 días antes de relogueo y nuevos tokens
...
LOGGING = {
    ...
    'loggers': {
        ...
        'savings.views.cripto_views': {
            'handlers': ['console'],
            'level': 'WARNING',  # silencia los DEBUG de cripto en producción
            'propagate': False,
        },
    },
}
