...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Cripto',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('8984c574-0167-4d6b-9580-813dedd29c4b'), editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Income',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('75ca2f5b-f8fc-4f1d-8b01-e3ed313be7d1'), editable=False, primary_key=True, serialize=False)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('date', models.DateTimeField()),
                ('type', models.CharField(max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
